'''Program for packing warehouse prodcucts indivudually and then collectivly

    * code uses decorator stacking
'''

def big_container(collective_material):
    '''packs boxes into the collective material passed'''
...
def warehouse_decorator(material):
    '''wraps single items into different materials'''
    def wrapper(our_function):
        def internal_wrapper(*args):
            our_function(*args)
